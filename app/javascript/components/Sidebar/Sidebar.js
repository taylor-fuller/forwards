        ...
        <ProSidebar>
            ...
            <div className="sidebar-container">
                ...
                <div className="sidebar-home">
                    <h2>Home</h2>
                    <div className={props.UI.activeSidebarOption === 'Dashboard' ? 'text-item active' : 'text-item'} id='dashboard' onClick={() => handleSidebarSelect('Dashboard')}><span>{homeIcon}</span><h3>Dashboard</h3></div>
                    <div className={props.UI.activeSidebarOption === 'My Tasks' ? 'text-item active' : 'text-item'} id='tasks' onClick={() => handleSidebarSelect('My Tasks')}><span>{taskIcon}</span><h3>My Tasks</h3></div>
                </div>
