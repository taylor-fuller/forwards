        ...
        return (props.team.projects.map(project => 
            <div key={project.id} id={project.id} className='active-team-project-item' onClick={() => props.amendActiveProject(project.id, project.name, {workspace_id: project.team_id, workspace_name: props.UI.activeWorkspace.workspace_name} )}>
                ...
                <div className="project-info">
                    ...
                    <div className="project-info-item"><div className="project-info-item-header">Completion</div><h3>{isNaN(Math.round((project.tasks.completed.length/project.tasks.all_tasks.length)*100)) ? '0' : (Math.round((project.tasks.completed.length/project.tasks.all_tasks.length)*100))}%</h3></div>
