        ...
        return (
            <div className="project-tasks-overview">
                <div className="project-info">
                    ...
                    <div className="project-info-item"><div className="project-info-item-header">Completion</div>{isNaN(Math.round((props.project.tasks.completed.length/props.project.tasks.all_tasks.length)*100)) ? <div style={{ width: 50, height: 50, margin: 'auto' }}><CircularProgressbar value={0} text={'0%'} /></div> : <div style={{ width: 50, height: 50, margin: 'auto' }}><CircularProgressbar value={(Math.round((props.project.tasks.completed.length/props.project.tasks.all_tasks.length)*100))} text={`${(Math.round((props.project.tasks.completed.length/props.project.tasks.all_tasks.length)*100))}%`} styles={buildStyles({rotation: 0.5})}/></div>}</div>
