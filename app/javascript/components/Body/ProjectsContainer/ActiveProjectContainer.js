        ...
        return (
            <div className="project-tasks-overview">
                <div className="project-info">
                    ...
                    <div className="project-info-item"><div className="project-info-item-header">Completion</div><h3>{isNaN(Math.round((props.project.tasks.completed.length/props.project.tasks.all_tasks.length)*100)) ? '0' : (Math.round((props.project.tasks.completed.length/props.project.tasks.all_tasks.length)*100))}%</h3></div>
